...
Truthfully, there might not be a unique "Willow." (Birth date might be distinct) But you can still filter and search for one. Also, you can perform EDA on the data.
